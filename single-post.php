        ...
        <div class="container">
            <div class="section-head">
                ...
                <ul class="c-bredcrumb">
                    ...
                    <!-- Post Title -->
                    <li><a href="#">Backpacking Essentials for a Weekend Hiking Trip</a></li>
                </ul>
            </div>
            <div class="row gy-5">
                <div class="col-lg-9">
                    <div class="left-content">
                        <!-- Post card -->
                        <div class="post-card">
                            <div class="card-thumb bg-cover" style="background-image: url('assets/img/single-post/post1.png')"></div>
                            <div class="card-content">
                                <div class="card-meta">
                                    <div class="meta-item post-author">
                                        <span class="category">Travel</span>
                                        <a href="#" class="author-name">Terence Whittle</a>
                                    </div>
